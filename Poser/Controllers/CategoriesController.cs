...
namespace Poser.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Slug,ParentId")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Slug,ParentId")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
